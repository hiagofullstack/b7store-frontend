...
import { RelatedProductsSkeleton } from "@/components/product/related-prodcuts-skeleton";
    ...
    return (
        <div>
            <div className="text-gray-500 mb-4">
                <Link href="/">Home</Link> &gt; <Link href={`/categories/${id}`}>Temporario</Link> &gt; {data.product.label}
            </div>
